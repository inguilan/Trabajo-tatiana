...
ALLOWED_HOSTS = os.environ.get("ALLOWED_HOSTS", "*").split(",")  # Solo para desarrollo
...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",    # servir static con whitenoise
...
# corsheaders ya instalado y añadido en INSTALLED_APPS y MIDDLEWARE
